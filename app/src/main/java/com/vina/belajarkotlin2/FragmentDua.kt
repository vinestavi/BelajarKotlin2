...
class FragmentDua : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val buttondua = getView()?.findViewById<Button>(R.id.btn_dua)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        var tvname = getView()?.findViewById<TextView>(R.id.tv_name)
        var tvdesc = getView()?.findViewById<TextView>(R.id.tv_desc)
